...
/*
  ...
  @access: Private
*/
export const createAGoal = expressAsyncHandler(async (req, res) => {
	if (req.body.text) {
...
/*
  ...
  @access: Private
*/
export const updateAGoal = expressAsyncHandler(async (req, res) => {
...
/*
  ...
  @access: Private
*/
export const deleteAGoal = expressAsyncHandler(async (req, res) => {
	try {
		const user = await User.findById(req.user.id);
		const goal = await Goal.findById(req.params.id);
